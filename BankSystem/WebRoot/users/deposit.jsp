    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
	            ...
	            <div class="row">
	            	<div class="col-sm-6">
	            		<form role="form" action="<%=request.getContextPath()%>/servlet/userDeposit" method="post">
	            			<div class="form-group ">
	            		 	...
	            		 	<div class="form-group ">
	            		 		<label for="depositAmount" class="control-label" >存款金额</label>
	            		 		<br>
	            		 		<input type="text" class="form-control" id="depositAmount" name="depositAmount" placeholder="请输入取款金额">
	            		 	</div>
	            		 	<br>
	            		 	<div class="form-group">
